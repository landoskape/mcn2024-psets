...
def evaluate_model(jobid, model_index, perturb_ratios, num_trials, psychometric_edges, perturb_type):
    ...
    for i, perturb_ratio in enumerate(tqdm(perturb_ratios)):
        c_loss, c_acc, c_ev, c_fix, c_psy = test_and_perturb(
            net, task, psychometric_edges, perturb_ratio=perturb_ratio, perturb_target="intrinsic", num_trials=num_trials, perturb_type=perturb_type,
        )
        ...
        c_loss, c_acc, c_ev, c_fix, c_psy = test_and_perturb(
            net, task, psychometric_edges, perturb_ratio=perturb_ratio, perturb_target="receptive", num_trials=num_trials, perturb_type=perturb_type,
        )
        ...
        c_loss, c_acc, c_ev, c_fix, c_psy = test_and_perturb(
            net, task, psychometric_edges, perturb_ratio=perturb_ratio, perturb_target="projective", num_trials=num_trials, perturb_type=perturb_type,
        )
